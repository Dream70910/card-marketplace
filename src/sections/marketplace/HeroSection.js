...
const HeroSection = () => {
  ...
  return (
    <div className="pt-36 max-lg:hidden">
      ...
      <div className="container px-5 mx-auto relative">
        ...
        <img
          ...
          className="block absolute max-w-[140px] lg:max-w-[200px] right-[-2rem] top-[25%] translate-y-[-50%] lg:top-[50%] lg:translate-y-[-60%] z-[2] drop-shadow-[0px_4px_40px_#fff5] pointer-events-none"
        />
        <div className="text-white product-ask-section bg-white/5 backdrop-blur-md flex flex-col-reverse lg:flex-row">
          <div className="flex flex-col w-full p-5 py-10 lg:p-12">
          ...
          /> */}
              ...
              <div className="flex items-center w-full space-x-4">
                <TextInput placeholder="Search for cards" divClassName="max-w-[460px]" />
                <Button isActive divClassName="border-style-decoration-container" buttonClassName="border-style-decoration">Search</Button>
              </div>
            </div>
          </div>

          {/*  */}
          <div className="h-[420px] lg:h-[unset] w-full lg:max-w-[480px] relative pointer-events-none z-[2] overflow-hidden">
            <img
              src="/assets/decorations/marketplace_decoration_1.png"
              className="hidden lg:block lg:max-w-[200px] absolute left-[-1.5rem] lg:left-[2rem] bottom-[50%] translate-y-[50%] z-[1] drop-shadow-[0px_4px_40px_#fff5]"
            />
            <img
              ...
              className="block max-w-[180px] bottom-[-4.5rem] lg:max-w-[200px] absolute right-[7.5%] lg:right-[-2.5rem] lg:translate-x-[-50%] translate-x-[-7.5%] lg:bottom-[-6.5rem] z-[1] drop-shadow-[0px_4px_40px_#fff5]"
            />

            <img
              src="/assets/decorations/marketplace_decoration_4.png"
              className="max-w-[130px] lg:max-w-[150px] block absolute top-[-2.5rem] lg:top-[-3.5rem] right-[3.5rem] lg:right-[6rem] z-[1] drop-shadow-[0px_4px_40px_#fff5]"
            />
